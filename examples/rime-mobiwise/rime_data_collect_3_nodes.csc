...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspSerial
        <history>routes~;sense~;send~;routes~;discover~;send~;routes~;discover~;routes~;discover~;routes~;discover~;disocver~;routes~;help~;</history>
      </interface_config>
      <motetype_identifier>sky2</motetype_identifier>
    </mote>
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>111.79974222807736</x>
        <y>43.605671733014766</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>4.371828141361506 0.0 0.0 4.371828141361506 -180.83204811064067 -4.080322788004729</viewport>
    </plugin_config>
    <width>400</width>
    <z>4</z>
    <height>400</height>
